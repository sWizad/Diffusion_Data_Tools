# python test_swinIR.py --task real_sr --scale 2 --model_path 'wd14_tagger_model\003_realSR_BSRGAN_DFO_s64w8_SwinIR-M_x2_GAN.pth' --folder_lq 'data\deadpool\wade_wilson\New folder'
import argparse
import cv2
import glob
import numpy as np
...
def setup(args):
    ...
    # 003 real-world image sr
    elif args.task in ['real_sr','lightweight_sr']:
        save_dir = f'results/swinir_{args.task}_x{args.scale}'
        if args.large_model:
            save_dir += '_large'
